...
const Sidebar = ({ isSidebarOpen, setIsSidebarOpen }) => {
    ...
    const menuItems = [
        ...
        { path: '/home', label: 'Home', icon: <FaHome className="w-5 h-5" /> },
        { path: '/activant', label: 'Activant', icon: <FaSearch className="w-5 h-5" /> },
        { path: '/unified-dashboard', label: 'DTC-DASH', icon: <FaThLarge className="w-5 h-5" /> }
